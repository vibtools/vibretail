...
<div class="login-stage">
    ...
    <section class="login-card">
        <div class="login-brand"><span class="brand-mark"><?php if (!empty($settings['logo_data'])): ?><img src="<?= htmlspecialchars($settings['logo_data'], ENT_QUOTES, 'UTF-8') ?>" alt="Business logo"><?php else: ?>C<?php endif; ?></span><span><?= htmlspecialchars($businessName, ENT_QUOTES, 'UTF-8') ?></span></div>
        <div class="login-copy"><span class="eyebrow">CLOUDCORE BUSINESS ERP</span><h1>Welcome back</h1><p>Sign in to manage your business.</p></div>
        ...
        <div class="login-developer">
            <strong>Developed by <a href="<?= htmlspecialchars(DEVELOPER_FACEBOOK_URL, ENT_QUOTES, 'UTF-8') ?>" target="_blank" rel="noopener"><?= htmlspecialchars(DEVELOPER_NAME, ENT_QUOTES, 'UTF-8') ?></a></strong>
            <nav><a href="<?= htmlspecialchars(DEVELOPER_COMPANY_URL, ENT_QUOTES, 'UTF-8') ?>" target="_blank" rel="noopener"><?= htmlspecialchars(DEVELOPER_COMPANY, ENT_QUOTES, 'UTF-8') ?></a><a href="<?= htmlspecialchars(DEVELOPER_GITHUB_URL, ENT_QUOTES, 'UTF-8') ?>" target="_blank" rel="noopener">GitHub</a><a href="license.php">Free Use License</a></nav>
        </div>
    </section>
</div>
