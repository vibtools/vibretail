...
if (PHP_SAPI === 'cli') {
    ...
    if (isset($options['help'])) {
        echo "VibRetail recovery installer / migration CLI\n";
...
if ($installerAction !== '') {
    ...
    try {
        ...
        if ($installerAction === 'install') {
            ...
            respond(['ok' => true, 'message' => 'VibRetail installed successfully.', 'result' => $result]);
        }
...
<?php else: ?>
<section class="card hero"><span class="tag">NEW INSTALLATION</span><h1>Install VibRetail</h1><p class="muted">No command line or environment-file editing required. The installer will check the server, configure the database, generate private keys and lock itself when finished.</p></section>
