...
function installer_seed_core(PDO $pdo, array $business): void
{
    ...
    $pdo->prepare('UPDATE settings SET website=?,tagline=? WHERE id=1')->execute([DEVELOPER_COMPANY_URL, 'Retail operations, simplified by Vib Tools.']);
...
function installer_write_environment(array $database, array $business): string
{
    ...
    $environment = in_array($httpHost, ['localhost', '127.0.0.1', '::1'], true)
        ...
        : 'production';
    $lines = [
        '# Generated by VibRetail secure installer. Do not publish or commit this file.',
